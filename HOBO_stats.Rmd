...
This data was collected using Onset HOBO temperature and humidity dataloggers during the course of our heating/cooling CEWL experiment. See __ for full details. 
...
We maintained temperatures of 13.7 +/- 2.1 for the cold primary acclimation, 24.4 +/- 0.5 for control, and 37.3 +/- 2.0 for hot. However, relative humidity was not consistent among primary acclimation treatments (33% for control but only 9% and 11% for cold and hot, respectively), a difference that was significantly different in a Tukey HSD ANOVA post-hoc test. Primary acclimation climate also occassionally varied among sampling dates: [listred and yellow pairwise diffs (Results_stats csvs) here]; b; c; d.
