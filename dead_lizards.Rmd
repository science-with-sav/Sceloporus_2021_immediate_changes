...
ggplot(raw_dead_vs_CEWL_per_temp_live) +
  ...
  # annotations for cooling group
  annotate("text", label = "D-Cool", parse = T,
  ...
  annotate("text", label = "D-Heat",parse = T, # dead
  ...
  annotate("text", label = "L-Heat", parse = T,# live
            x = 37, y = 20, size = 2.5, color = heat) +
  annotate("text", label = "L-Cool", parse = T,# live
