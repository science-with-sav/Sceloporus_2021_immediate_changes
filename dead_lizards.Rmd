...
ggplot(raw_dead_vs_CEWL_per_temp_live) +
  ...
  scale_shape_manual(values = c("A control" = 1,
                                "A cooling" = 6,
                                "D control" = 1,
                                "D heating" = 2,
                                "Live - Control" = 21,
   ...
   # control group
  annotate("text", x = 23.2, y = 32, label = "Control[Heat]", parse = T,
           size = 2.5, family = "sans", color = control2) +
  annotate("text", x = 22.5, y = 25, label = "Control[Cool]", parse = T,
           size = 2.5, family = "sans", color = control1) +
  # annotate("text", x = 24, y = 12, label = "Control", parse = T,
  #          size = 2.9, family = "sans", color = control) +
  
  # annotations for cooling group
  annotate("text", label = "Cooling", 
            x = 24, y = 0, size = 2.9, color = cool) +
  annotate("text", x = 10.5, y = 2.5, label = "T[15]", parse = T,
  ...
  annotate("text", label = "Heating", # dead
            x = 29.5, y = 58, size = 2.9, color = heat) +
  annotate("text", x = 20.1, y = 40, label = "T[1]", parse = T,
           size = 3, family = "sans", color = heat) +
  annotate("text", x = 36.5, y = 67, label = "T[15]", parse = T,
           size = 3, family = "sans", color = heat) +
  
  # annotations for heating group - live
  # annotate("text", label = "Heating", # live
  #           x = 21, y = 22, size = 2.9, color = heat) +
  # annotate("text", x = 16, y = 10, label = "T[1]", parse = T,
  #          size = 3, family = "sans", color = heat) +
  # annotate("text", x = 39.5, y = 28, label = "T[15]", parse = T,
  #          size = 3, family = "sans", color = heat) +
...
# export
ggsave(filename = "dead_liz_time_temp_new.pdf",
       plot = dead_arrange2,
       path = "./Results_Figures",
       device = "pdf",
       dpi = 600,
