...
ggplot(raw_dead_vs_CEWL_per_temp_live) +
  ...
  scale_shape_manual(values = c("A control" = 1,
   ...
   # control group
  annotate("text", x = 23.2, y = 32, label = "D-Con[Heat]", parse = T,
           size = 2.5, family = "sans", color = control2) +
  annotate("text", x = 22.5, y = 25, label = "D-Con[Cool]", parse = T,
           size = 2.5, family = "sans", color = control1) +
  
  # annotations for cooling group
  annotate("text", label = "D-Cool", 
            x = 12, y = 6, size = 2.5, color = cool) +
  ...
  annotate("text", label = "D-Heat", # dead
            x = 29.5, y = 58, size = 2.5, color = heat) +
  annotate("text", x = 20.1, y = 40, label = "T[1]", parse = T,
  ...
  annotate("text", label = "L-Heat", # live
            x = 37, y = 20, size = 2.5, color = heat) +
  annotate("text", label = "L-Cool", # live
            x = 37, y = 12, size = 2.5, color = cool) +
  annotate("text", x = 25, y = 13, label = "L-Con", parse = T,
