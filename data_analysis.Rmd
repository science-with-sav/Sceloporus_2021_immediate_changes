...
```{r}
lizard_coeffs_temp <- data.frame(emtrends(lizard_temp_time_lm, 
...
ggplot() +
  ...
  ylim(-1.7, 1.7) +
   ...
   annotate("text", x = 1, y = 1.7, label = "a", size = 3) +
   annotate("text", x = 2, y = 1.7, label = "b", size = 3) +
   annotate("text", x = 3, y = 1.7, label = "c", size = 3) +
...
## CEWL & Tb x relative & rate of change
